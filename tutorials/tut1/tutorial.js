...
SECOND: ADD CONTAINER FOR IMAGES 
*/
{
	"name": "testPage ",
	"classes": [
...
The ins: [fnName, topic, channel] //these are going to be used to create a subscription 
...
/*
Now let's make sure the setup is working! After loading the page you should NOT
see a container and when you click the 'Add' button it shows up. If you've done 
...
also give an 'img' attribute to make it. Let's give it some ImageButtons! 
*/
...
And you didn't even have to write a line of code :D We'll be looking through some of the 
smaller details in other tutorials and also doing some intros in making blocks programmatically. 
*/